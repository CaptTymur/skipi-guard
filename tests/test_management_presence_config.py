...
class ManagementPresenceConfigTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        with (ROOT / "configs" / "homes" / "management.json").open("r", encoding="utf-8") as handle:
    ...
    def test_plugin_host_runs_presence_harness(self) -> None:
        ...
        self.assertEqual(harnesses["management_plugin_isolation"], "node tests/management_plugin_isolation_harness.mjs")
        self.assertEqual(harnesses["management_presence_contract"], "node tests/management_presence_contract_harness.mjs")
    ...
    def test_plugin_host_allows_presence_contract_files_but_not_workflow(self) -> None:
        ...
        self.assertIn("tests/management_presence_contract_harness.mjs", allowed)
