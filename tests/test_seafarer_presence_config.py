...
class SeafarerPresenceConfigTests(unittest.TestCase):
    @classmethod
    ...
    def test_plugin_host_runs_presence_and_provenance_harnesses(self) -> None:
        ...
        self.assertEqual(harnesses["seafarer_bundled_plugin_isolation"], "node tests/bundled_plugin_isolation_harness.mjs")
        self.assertEqual(harnesses["seafarer_build_provenance"], "node tests/build_provenance_harness.mjs")
        self.assertEqual(harnesses["seafarer_presence_contract"], "node tests/seafarer_presence_contract_harness.mjs")
    ...
    def test_plugin_host_allows_presence_contract_files_but_not_workflow(self) -> None:
        ...
        self.assertIn("tests/seafarer_presence_contract_harness.mjs", allowed)
